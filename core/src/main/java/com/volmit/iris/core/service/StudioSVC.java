...
public class StudioSVC implements IrisService {
    public static final String LISTING = "https://ghproxy.imciel.com/https://raw.githubusercontent.com/IrisDimensions/_listing/main/listing-v2.json";
        ...
        J.s(() -> {
            ...
            if (!f.exists()) {
                ...
                if (pack.equals("overworld")) {
                    String url = "https://ghproxy.imciel.com/https://github.com/IrisDimensions/overworld/releases/download/" + INMS.OVERWORLD_TAG + "/overworld.zip";
    ...
    public void download(VolmitSender sender, String repo, String branch, boolean trim, boolean forceOverwrite, boolean directUrl) throws JsonSyntaxException, IOException {
        String url = directUrl ? branch : "https://ghproxy.imciel.com/https://github.com/" + repo + "/archive/refs/heads/" + branch + ".zip";
